...
if (!error_get_last()) {
    ...
    $bodytelegram = "Оставить заявку.%0AИмя: $firstName.%0AФамилия: $lastName%0AТелефон: $phone%0AEmail: $email%0AБонусы: $bonus1, $bonus2,$bonus3, $bonus4%0AО проекте: $comment";
