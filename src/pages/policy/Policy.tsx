            ...
            <Container>
                <Content>
                    ...
                    <Text>
                        ...
                        Компания может получить при использовании сайта veon-tech.by (далее — Сайт) и/или данные о
                        ...
                        veon-tech.by/privacy в соответствии с п. 4. ст. 17 Закона Республики Беларусь от 07.05.2021 №
                    ...
                    <ol>
                        <li>ОБЩИЕ ПОЛОЖЕНИЯ
                            <ol>
                                <li>
                                    Персональными данными является любая информация, относящаяся к идентифицированному
                                ...
                                <li>
                                    Обработка персональных данных Компанией включает в себя любое действие или
                                ...
                                <li>
                                    ...
                                    <ol>
                                        ...
                                        <li>
                                            ...
                                            рассылки, ограничивается завершением маркетинговых кампаний или отказом
                                        ...
                                        <li>
                                            ...
                                            Metrika, Google Analytics в целях обеспечения эффективной работы Сайта на
                                            ...
                                            найти на ресурсе aboutcookies.org.
                                        </li>
                                    </ol>
                                </li>
                            </ol>
                            ...
                            <ol>
                                ...
                                <li>Компания может передавать персональные данные Пользователя третьим лицам,
                                    ...
                                    <Text>Яндекс Метрика — сервис веб-аналитики, предоставляемый ООО «Яндекс». Адрес: г.
                                        Москва, ул. Льва Толстого, д. 16, 119021. Политика конфиденциальности Яндекс.
                                    </Text>
                                    <Text>Google Analytics — сервис веб-аналитики, предоставляемый компанией Google,
                                        ...
                                        Mountain View, CA 94043, USA. Политика конфиденциальности Google.
                                    </Text>
                                    <Text>Хантфлоу — сервис по ведению базы кандидатов, предоставляемый ООО «Хантфлоу».
                                        ...
                                        Бутырский, ул. Новодмитровская, д. 2, корп. 2, помещение 27А. Политика
                                        конфиденциальности Хантфлоу.
                                    </Text>
                                    <Text>Pipedrive — сервис по управления взаимоотношениями с клиентами,
                                        ...
                                        Petersburg, FL 33701, USA. Политика конфиденциальности Pipedrive.
                                    </Text>
                                </li>
                        ...
                        <li>ЗАКЛЮЧИТЕЛЬНЫЕ ПОЛОЖЕНИЯ
                            <ol>
                                ...
                                <li>Подробные условия обработки файлов «cookie» содержаться по ссылке
                                    veon-tech.by/cookies.
                                </li>
                            </ol>
                        </li>
                    </ol>
