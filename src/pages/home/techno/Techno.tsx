            ...
            <Container>
                ...
                <TechnoContent>
                    ...
                    <TechnoText className='animate'>
                        RIZOFT стремится помогать компаниям со всего мира расти, повышать производительность, оптимизировать бизнес-процессы и опережать конкурентов. <br/> Всякий раз, когда Вашему бизнесу требуется новый инструмент или продукт, мы применяем наши знания и навыки для реализации интеллектуального и надежного решения по конкурентоспособной цене.
                    </TechnoText>
                </TechnoContent>
