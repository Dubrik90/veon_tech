...
export const Techno = () => {
    return (
        <TechnoWrapper >
            <Container>
                <Title className='animate'>Большой опыт разработки проектов различной сложности
                </Title>
                <TechnoContent>
                    ...
                    <TechnoText className='animate'>
                        VEON-TECH стремится помогать клиентам расти, повышать производительность, оптимизировать
                        бизнес-процессы и опережать конкурентов.
                        <br/> Всякий раз, когда Вашему бизнесу требуется новый инструмент или продукт, мы применяем наши
                        знания и навыки для реализации интеллектуального и надежного решения по конкурентоспособной
                        цене.
                    </TechnoText>
                </TechnoContent>
